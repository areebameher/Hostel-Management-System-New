 ...
 * @author dell
 */
public class currentEmployees extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(currentEmployees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
