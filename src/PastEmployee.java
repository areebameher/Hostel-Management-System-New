 ...
 * @author dell
 */
public class PastEmployee extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PastEmployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
